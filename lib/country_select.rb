...
module ActionView
  module Helpers
    module FormOptionsHelper
      ...
      COUNTRIES = ["Afghanistan", "Åland Island", "Albania", "Algeria", "American Samoa", "Andorra", "Angola",
        ...
        "Liberia", "Libyan Arab Jamahiriya", "Liechtenstein", "Lithuania", "Luxembourg", "Macao", "Macedonia, Republic of",
        ...
        "Rwanda", "Saint Barthélemy", "Saint Helena", "Saint Kitts and Nevis", "Saint Lucia", "Saint Martin (French part)",
      ...
      ] unless const_defined?("COUNTRIES") && Rails::VERSION::STRING >= '2.2.0'
    end
